...
const OwnerSignUpScreen = () => {
    ...
    const validateBusinessDetails = () => {
        ...
        if (!propertyCount || propertyCount < 1) {
            newErrors.propertyCount = 'Please enter the number of properties you own';
        }
    ...
    // Phone verification functions (reuse from student signup)
    ...
    return (
        <Container maxWidth="md" sx={{ mt: 4, mb: 4, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <Paper sx={{ p: 4, borderRadius: 3, flex: 1 }}>
                    ...
                    {activeStep === 1 && (
                        <Box>
                            ...
                            <TextField
                                ...
                                helperText={errors.propertyCount}
                                sx={{ mb: 2 }}
                            />
                ...
                {/* Contact Details for owner (similar to student) */}
                {activeStep === 2 && (
                    <Box sx={{ mt: 4, p: 3, backgroundColor: alpha(theme.palette.grey[50], 0.3), borderRadius: 2 }}>
                    <Typography variant="h6" sx={{ mb: 3 }}>
                        Contact Information
                    </Typography>
                ...
                <Box sx={{ mt: 3, textAlign: 'center' }}>
                    <Typography variant="body2" color="text.secondary">
                        ...
                        <Link component={RouterLink} to="/owner-login" sx={{ fontWeight: 600 }}>
                            Log in
                        </Link>
                    </Typography>
